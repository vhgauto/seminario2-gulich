...
<center>
<rosa>{{< iconify carbon:development size=8x >}}</rosa>
</center>

# Herramientas

- <rosa>{{< iconify fa6-brands:r-project >}} R y  {{< iconify akar-icons:python-fill >}} Python</rosa>: lectura y obtención de datos, procesamiento y almacenamiento de resultados, generación de figuras, tablas y mapas.
<br>
<br>
- <rosa>{{< iconify fe:git >}} Git y {{< iconify mdi:github >}} GitHub</rosa>: gestión del control de versiones y colaboración entre integrantes del proyecto.
<br>
<br>
