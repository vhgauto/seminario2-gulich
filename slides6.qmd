...
<br>
<rosa>{{< iconify fa6-brands:r-project >}}</rosa>
:::
::: {.column width="25%"}
{{< iconify devicon:julia-wordmark >}}
<br>
<rosa>{{< iconify simple-icons:observable >}}</rosa>
:::
::: {.column width="25%"}
<rosa>{{< iconify tabler:sql >}}</rosa>

<br>
<rosa>{{< iconify devicon-plain:bash >}}</rosa>
:::
::: {.column width="25%"}
{{< iconify vscode-icons:file-type-mermaid >}}
<br>
<rosa>{{< iconify file-icons:graphviz >}}</rosa>
:::
:::
