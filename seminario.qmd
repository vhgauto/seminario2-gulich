...
- `quarto publish` allows to deploy the website in <rosa>Quarto Pub {{< iconify simple-icons:quarto >}}</rosa> or <rosa>GitHub Pages {{< iconify mdi:github >}}</rosa>.
...
# {data-hide-slide-number="true" .unnumbered .unlisted background-color="#333333" footer='false' .hide-logo .center}
