...
:::: {.column width="45%"}
[<blanco>{{< iconify ic:round-home >}} </blanco> <rosa> MS Víctor Gauto</rosa>](https://vhgauto.github.io/)

[<blanco>{{< iconify ic:outline-email >}} </blanco> <rosa> victor.gauto@ca.frre.utn.edu.ar</rosa>](mailto:victor.gauto@ca.frre.utn.edu.ar)
::::
...
[<rosa style='font-size:2em'>{{< iconify mdi:twitter >}}</rosa>](https://twitter.com/vhgauto)

[<rosa style='font-size:2em'>{{< iconify mdi:instagram >}}</rosa>](https://www.instagram.com/vhgauto/)

[<rosa style='font-size:2em'>{{< iconify mdi:github >}}</rosa>](https://github.com/vhgauto)

[<rosa style='font-size:2em'>{{< iconify ri:bluesky-fill >}}</rosa>](https://bsky.app/profile/vhgauto.bsky.social)

[<rosa style='font-size:2em'>{{< iconify mdi:mastodon >}}</rosa>](https://fosstodon.org/@vhgauto)
...
![](https://ig.conae.unc.edu.ar/wp-content/uploads/sites/68/2022/04/cropped-cromas-68-1.png){height="70px"}
