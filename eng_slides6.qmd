...
format:
  revealjs:
    ...
    footer: |
      <b class="fondo-azul"><blanco>MS Víctor Gauto <rosa>{{< iconify svg-spinners:bouncing-ball >}}</rosa> Elevate research projects with <quarto-portada>Quarto</quarto-portada>
    slide-number: c/t
    progress: true
    hash-type: number
    date: today
...
- Generate a `.pdf` version of the website, for easy sharing and to read without Internet connection.
...
<azul style='font-family:Rufina'>**Thanks for your time**</azul>
...
[{{< iconify ph:download-fill >}} **Download** {{< iconify dashicons:pdf >}}](https://raw.githubusercontent.com/vhgauto/seminario2-gulich/main/slides6.pdf)
