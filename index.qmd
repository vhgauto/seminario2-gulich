...
author:
  - name: <vhg>Víctor Gauto, **MS** [{{< iconify fa6-brands:orcid >}}](https://orcid.org/0000-0001-9960-8558)</vhg>
    ...
    corresponding: true
  - name: Matías Bonansea, **PhD** [{{< iconify fa6-brands:orcid >}}](https://orcid.org/0000-0003-1953-2595)
    affiliation:
      - name: <b>ICBIA</b> (UNRC, CONICET)
        url: https://icbia.conicet.gov.ar/
  - name: Anabella Ferral, **PhD** [{{< iconify fa6-brands:orcid >}}](https://orcid.org/0000-0002-9383-7728)
    affiliation:
      - name: <b>Instituto Gulich</b> (UNC, CONAE)
        url: https://ig.conae.unc.edu.ar/
  - name: Osvaldo Cardozo, **PhD** [{{< iconify fa6-brands:orcid >}}](https://orcid.org/0000-0002-0345-4505)
    affiliation:
      - name: <b>IIDTHH</b> (UNNE, CONICET)
        url: https://iidthh.conicet.gov.ar/
  - name: Claudia Giardino, **PhD** [{{< iconify fa6-brands:orcid >}}](https://orcid.org/0000-0002-3937-4988)
    affiliation:
      - name: <b>IREA</b> (CNR)
...
Usually, while doing the Project, we don't recognize all the data as is being collected. The knowledge acquired is dispersed in multiple files.

When the Project is near the end we recognize this situation.
::::
...
- <rosa>{{< iconify simple-icons:quarto >}} Quarto</rosa>: to gather all the content in a single file, render a website and to publish.
...
![](https://dataspace.copernicus.eu/themes/custom/copernicus/logo.svg){width="40%" fig-align="center"}
...
- Atmospheric correction
  + [ACOLITE](https://github.com/acolite/acolite), atmospheric correction algorithms for aquatic applications
...
- Combines [code execution]{.fragment .hl-blanco fragment-index=1}, from programming language scripts, and [narrative text]{.fragment .hl-blanco fragment-index=1}, from `markdown`, to create an output file in multiple formatted options.
...
- A [Project website]{.fragment .hl-blanco} was developed using Quarto Manuscript.<br><br>

- By combining multiple tools, the website content is [updated automatically]{.fragment .hl-blanco} and publish.<br><br>

- Project members [collaborate]{.fragment .hl-blanco} in the development, in charge of their own sections.<br><br>

- We can check the Project progress and be [proud]{.fragment .hl-blanco} of what is done and plan what is left.<br><br>
