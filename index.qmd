...
- Fonts, from [Google Fonts {{< iconify simple-icons:googlefonts >}}](https://fonts.google.com/)
...
![](https://api.iconify.design/vscode-icons/file-type-scss2.svg){.absolute bottom=20 right=20 width="200" height="200"}
...
Log file (`renv.lock`) that allows environment reproducibility.
...
![](https://dataspace.copernicus.eu/themes/custom/copernicus/logo.svg){width="50%" fig-align="left"}
...
<rosa style='font-size:4rem'>{{< iconify mdi:github >}}</rosa> GitHub for cloud storage service and sharing.
