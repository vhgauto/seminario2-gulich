...
![](img/portada.png){width="75%" fig-align="center"}
...
![](img/toc.png){width="35%" fig-align="center"}
...
![](img/notebooks.png){width="60%" fig-align="center"}
...
![](https://api.iconify.design/akar-icons/sass-fill.svg){.absolute bottom=20 right=20 width="200" height="200"}
...
Log file (`renv.lock`) that allows environment reproducibility, with package version and location repository.

<!-- TODO cambiar el callout -->
...
[{{< iconify teenyicons:pdf-solid >}} &nbsp; **Download presentation** &nbsp; {{< iconify ph:download-fill >}}](https://raw.githubusercontent.com/vhgauto/seminario2-gulich/main/index.pdf)
